...
% Last Modified by GUIDE v2.5 21-Jun-2016 21:57:34
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global fullFIleName2;
[fileName1 folder1] = uigetfile({'*.*'},'All files');

personImage = imread([folder1,fileName1]);
imshow(personImage,'Parenrt',handles.axes2);
